...
//console.log(model);
		this.editorDiv = this.model.editorDiv;
		this.graphDiv = this.model.graphDiv;
		this.svg = this.model.svg;
		this.bgText = this.model.bgText;
...
if (portDiv.className == "node_in_port"){
